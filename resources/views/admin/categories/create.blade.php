    ...
    <div class="flex items-center justify-between">
        <div>
            <div class="flex items-center gap-2 text-xs text-slate-400 mb-1">
                ...
                <span class="text-slate-200">New Category</span>
            </div>
            <h2 class="text-xl font-bold text-white tracking-tight">Create Product Category</h2>
        </div>
    ...
    <div class="admin-card rounded-3xl p-6 sm:p-8">
        <form action="{{ route('admin.categories.store') }}" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <p class="text-[10px] text-slate-400 mt-1">A URL slug will be automatically created from the name.</p>
            </div>
            ...
            <div>
                ...
                <textarea id="description" name="description" rows="4"
                          ...
                          placeholder="Brief summary of items classified under this category...">{{ old('description') }}</textarea>
            </div>
